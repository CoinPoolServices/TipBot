...
let dngrFee = config.get('dngr').paytxfee;
...
exports.tiphelp = {
  ...
  process: function(bot, message) {
    message.author.send(
      ...
      '  **DangerCoin (DNGR) Tipper**\n    Transaction Fees: **' + dngrFee + '**\n' +         
      '__**Commands**__\n' +
      ...
      '__**Examples**__\n' +
      '  **' + prefix + 'tipdngr @MSFTserver 10**\n' +
        '  **' + prefix + 'tipdngr withdraw DOGEaddressHERE 10**\n' +
        '  **' + prefix + 'tipdngr private @MSFTserver 10**\n' +
        '  **' + prefix + 'tipdngr balance**\n' +
        '  **' + prefix + 'tipdngr deposit**\n'
    );
  }
};
